...
def update_attendance(input_dict: dict[str, list[str]], week_str: str, student_str: str) -> dict[str, list[str]]:
    ...
    if week_str == "" and student_str == "":
        return input_dict
    if week_str in input_dict and student_str in input_dict[week_str]:
        return input_dict
...
update_attendance(attendance_log, "Tuesday", "A")
